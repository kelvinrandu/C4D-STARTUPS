...
<!-- Mirrored from 7oroof.com/tfdemos/whole/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Sep 2017 10:53:57 GMT -->
<head>
<!-- Document Meta
    ============================================= -->
<meta charset="utf-8">
...
<link href="whole/assets/images/favicon/favicon.html" rel="icon">
...
<!-- Stylesheets
    ============================================= -->
<link href="whole/assets/css/external.css" rel="stylesheet">
<link href="whole/assets/css/bootstrap.min.css" rel="stylesheet">
<link href="whole/assets/css/style.css" rel="stylesheet">


<!-- RS5.0 Main Stylesheet -->
<link rel="stylesheet" type="text/css" href="whole/assets/revolution/css/settings.css">
<link rel="stylesheet" type="text/css" href="whole/assets/revolution/css/layers.css">
<link rel="stylesheet" type="text/css" href="whole/assets/revolution/css/navigation.css">
...
<header id="navbar-spy" class="header header-1 header-transparent header-fixed">
	<nav id="primary-menu" class="navbar navbar-fixed-top">
		<div class="container">
			...
			<!-- Collect the nav links, forms, and other content for toggling class="collapse navbar-collapse pull-center" -->
			<div  class="collapse navbar-collapse pull-right
			" id="navbar-collapse-1">
				<ul class="nav navbar-nav nav-pos-left navbar-left">
				...
				<div class="container">
					<div class="row">
						...
						<!--<div class="col-md-3">
							<ul>
								<li>
									<a href="home-portfolio-pinterest.html">home portfolio pinterest</a>
								</li>
								<li>
									<a href="home-portfolio-gallery.html">home portfolio gallery</a>
								</li>
								<li>
									<a href="home-portfolio-masonry.html">home portfolio masonry</a>
								</li>
								<li>
									<a href="home-portfolio-sidebar.html">home portfolio sidebar</a>
								</li>
								<li>
									<a href="home-portfolio-simple.html">home portfolio simple</a>
								</li>
							</ul>
						</div>
						<!-- .col-md-3 end -->
						...
						<!--<div class="col-md-3">
							<ul>
								<li>
									<a href="home-portfolio-parallax.html">home portfolio parallax</a>
								</li>
								<li>
	...
	<li class="has-dropdown">
		<a href="#" data-toggle="dropdown" class="dropdown-toggle menu-item">register</a>
	...
	<!-- Features Menu-->
	<li class="has-dropdown">
		<a href="#" data-toggle="dropdown" class="dropdown-toggle menu-item">Startups</a>
		<ul class="dropdown-menu">
			<!--<li class="dropdown-submenu">
				<a href="#" data-toggle="dropdown" class="dropdown-toggle">sliders</a>
				<ul class="dropdown-menu">
					<li class="has-dropdown">
						<a href="#" data-toggle="dropdown" class="dropdown-toggle">revolution</a>
						<ul class="dropdown-menu">
							<li>
								<a href="slider-rs-1.html">slider 1</a>
							</li>
							<li>
								<a href="slider-rs-2.html">slider 2</a>
							</li>
							<li>
								<a href="slider-rs-3.html">slider 3</a>
							</li>
							<li>
								<a href="slider-rs-4.html">slider 4</a>
							</li>
							<li>
								<a href="slider-rs-5.html">slider 5</a>
							</li>
							<li>
								<a href="slider-rs-6.html">slider 6</a>
							</li>
							<li>
								<a href="slider-rs-7.html">slider 7</a>
							</li>
							<li>
								<a href="slider-rs-8.html">slider 8</a>
							</li>
						</ul>
					</li>-->
					<li class="has-dropdown">
						<a href="#" data-toggle="dropdown" class="dropdown-toggle">SPM</a>
						<!--<ul class="dropdown-menu">
							<li>
			...
			<li class="dropdown-submenu">
				...
				<ul class="dropdown-menu">
					<li><a href="header-20.html">dark header</a></li>
					...
					<li class="has-dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li>
								<a href="header-4.html">transparent 4</a>
							</li>
							<li>
							...
							<li>
								<a href="header-11.html">transparent 7</a>
							</li>
							<li>
								<a href="header-12.html">transparent 8</a>
							</li>
							<li>
								<a href="header-13.html">transparent 9</a>
							</li>
						</ul>
					</li>
					<li class="has-dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li>
								<a href="header-10.html">white 2</a>
							</li>
							<li>
							...
							<li>
								<a href="header-19.html">white 5</a>
							</li>
						</ul>
					</li>
					...
					<li class="has-dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li>
								<a href="header-13.html">centered 2</a>
							</li>
							<li>
								<a href="header-17.html">centered 3</a>
							</li>
							<li>
								<a href="header-18.html">centered 4</a>
							</li>
							<li>
								<a href="header-19.html">centered 5</a>
							</li>
						</ul>
					</li>
					...
					<li class="has-dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li>
								<a href="header-9.html">fullscreen 2</a>
							</li>
							<li>
								<a href="header-10.html">fullscreen 3</a>
							</li>
						</ul>
					</li>
					<li class="has-dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li>
								<a href="header-14.html">topbar 2</a>
							</li>
							<li>
								<a href="header-18.html">topbar 3</a>
							</li>
						</ul>
					</li>
					...
					<li class="has-dropdown">
						...
						<ul class="dropdown-menu">
							<li>
								<a href="header-3.html">fixed 1</a>
							</li>
							<li>
								<a href="header-4.html">fixed 2</a>
							</li>
						</ul>
					</li>
					...
					<li class="has-dropdown">
						...
						<ul class="dropdown-menu">
							<li>
								<a href="header-3.html">bordered 1</a>
							</li>
							<li>
								<a href="header-12.html">bordered 2</a>
							</li>
							<li>
								<a href="header-13.html">bordered 3</a>
							</li>
						</ul>
					</li>
			...
			<li class="dropdown-submenu">
				<a href="#" data-toggle="dropdown" class="dropdown-toggle">page templates</a>
				<ul class="dropdown-menu">
					<li>
						<a href="page-layout-fullwidth.html">fullwidth</a>
					</li>
					<li>
						<a href="page-layout-fullwidth-wide.html">fullwidth</a>
					</li>
					<li>
					...
					<div class="row">
						...
						<!--<div class="col-md-3">
							...
							<ul>
								...
								<li>
									<a href="portfolio-grid-4cols-sidebar.html">grid 4 columns sidebar</a>
								</li>
							</ul>
						</div>
						<!-- .col-md-3 end -->
						...
						<!-- Column #3 -->
						<!--<div class="col-md-3">
							<a href="#">portfolio creative</a>
							<ul>
								<li>
									<a href="portfolio-pinterest-3cols.html">pinterest 3 columns</a>
								</li>
								<li>
									<a href="portfolio-pinterest-4cols.html">pinterest 4 columns</a>
								</li>
								<li>
									<a href="portfolio-pinterest-4cols-wide.html">pinterest 4 columns wide</a>
								</li>
								<li>
									<a href="portfolio-pinterest-5cols-wide.html">pinterest 5 columns wide</a>
								</li>
								<li>
									<a href="portfolio-masonry-grid.html">masonry grid</a>
								</li>
								<li>
					...
					<div class="row">
						<!-- Column #1 -->
							...
							<ul>
								...
								<li>
									<a href="elements-post-carousel.html"><i class="fa fa-newspaper-o"></i>post carousel</a>
								</li>
								<li>
									<a href="elements-portfolio.html"><i class="fa fa-building-o"></i>portfolio</a>
								</li>
								<li>
						...
						<!-- Column #2 -->
							...
							<ul>
								...
								<li>
									<a href="elements-maps.html"><i class="fa fa-map-marker"></i>google maps</a>
								</li>
							</ul>
						</div>
						<!-- .col-md-3 end -->
						...
						<!--<div class="col-md-3">
							...
							<ul>
								<li>
									<a href="elements-counter-down.html"><i class="fa fa-bomb"></i>countdown</a>
								</li>
								<li>
									<a href="elements-counters.html"><i class="fa fa-dashboard"></i>counters</a>
								</li>
								<li>
									<a href="elements-number-process.html"><i class="fa fa-dot-circle-o"></i>number process</a>
								</li>
								<li>
								...
								<li>
									<a href="elements-typed-out.html"><i class="fa fa-edit"></i>typed out</a>
								</li>
						...
						<!--<div class="col-md-3">
							...
							<ul>
								...
								<li>
									<a href="elements-navigation.html"><i class=""></i>navigation</a>
								</li>
								<li>
									<a href="elements-messages.html"><i class="fa fa-exclamation-triangle"></i>messages</a>
								</li>
								<li>
									<a href="elements-media.html"><i class="fa fa-play-circle"></i>media</a>
								</li>
								<li>
									<a href="elements-tables.html"><i class="fa fa-table"></i>tables</a>
								</li>
								<li>
					...
					<div class="module-content module-box cart-box">
						<div class="cart-overview">
							<ul class="list-unstyled">
								<li>
									<img class="img-responsive" src="whole/assets/images/shop/thumb/6.jpg" alt="product"/>
									<div class="product-meta">
										<h5 class="product-title">Mismo Briefcase</h5>
										<p class="product-price">1 x $ 38.00</p>
									</div>
									<a class="cart-cancel" href="#">cancel</a>
								</li>
								<li>
									<img class="img-responsive" src="whole/assets/images/shop/thumb/7.jpg" alt="product"/>
									<div class="product-meta">
										<h5 class="product-title">Brown Leather</h5>
										<p class="product-price">1 x $ 33.00</p>
									</div>
									<a class="cart-cancel" href="#">cancel</a>
								</li>
							</ul>
...
<div class="widget widget-recent-posts">
	...
	<div class="widget--content">
		<div class="entry">
			<img src="whole/assets/images/blog/thumb/1.jpg" alt="title"/>
			<div class="entry-desc">
				<div class="entry-title">
					<a href="#">Four ways to yourself up on the Blue Monday!</a>
				</div>
				<div class="entry-meta">
					<a href="#">Oct 15, 2016</a>
				</div>
			</div>
		</div><!-- .recent-entry end -->

		<div class="entry">
			<img src="whole/assets/images/blog/thumb/2.jpg" alt="title"/>
			<div class="entry-desc">
				<div class="entry-title">
		...
		<div id="slider1" class="rev_slider"  data-version="5.0">
			<ul>
				...
				<li data-transition="zoomout"
					...
					<!-- MAIN IMAGE -->
					<img src="whole/assets/images/sliders/slide-bg/1.jpg" alt="Slide Background Image"  width="1920" height="1280">
					<!-- LAYER NR. 1 -->
					<div class="tp-caption"
						...
						<div class="slide--subheadline">Great Business Solutions</div>
					</div>
					...
					<div class="tp-caption"
						...
						data-responsive_offset="on"
						>
						<div class="slide--headline">We Create Your Future!</div>
					</div>
					...
					<div class="tp-caption"
						...
						data-responsive_offset="on"
						>
						<div class="slide--bio text-center">Our strategists will help you set an objective and choose your tools, developing<br> a plan that is custom-built for your startup. </div>
					</div>
				...
				<li data-transition="zoomout"
					...
					data-masterspeed="2000">
					<!-- MAIN IMAGE -->
					<img src="whole/assets/images/sliders/slide-bg/2.jpg" alt="Slide Background Image"  width="1920" height="1280">
					<!-- LAYER NR. 1 -->
					<div class="tp-caption"
						data-x="center" data-hoffset="0"
						data-y="center" data-voffset="-130"
						...
						data-splitout="none"
						data-responsive_offset="on">
						<div class="slide--subheadline">we do the best</div>
					</div>
					...
					<div class="tp-caption"
						...
						data-responsive_offset="on"
						>
						<div class="slide--headline">We Create a holistic environment for development</div>
					</div>
					...
					<div class="tp-caption"
						...
						<div class="slide-action">
							<a class="btn btn--slide btn--secondary btn--white" href="#">Read More </a>
							<a class="btn btn--slide btn--white btn--bordered" href="#">Register</a>
						</div>
					</div>
				</li>
				...
				<li data-transition="zoomout"
					...
					data-easein="Power4.easeInOut"
					data-easeout="Power4.easeInOut"
					data-masterspeed="2000" class="bg-overlay bg-overlay-dark">
					<!-- MAIN IMAGE -->
					<img src="wholeassets/images/sliders/slide-bg/3.jpg" alt="Slide Background Image"  width="1920" height="1280">
					<!-- LAYER NR. 1 -->
					<div class="tp-caption"
						data-x="center" data-hoffset="0"
						data-y="center" data-voffset="-130"
						...
						data-splitout="none"
						data-responsive_offset="on">
						<div class="slide--subheadline">we provide all the support a startup needs</div>
					</div>
					...
					<div class="tp-caption"
						...
						data-responsive_offset="on"
						>
						<div class="slide--headline">We nuture ideas</div>
					</div>
...
<!-- #hero end --><!-- Heading #1
============================================= -->
<section id="heading1" class="bg-white heading heading-1 pb-100">
	<div class="container">
			...
			<div class="col-xs-12 col-sm-12 col-md-6 pr-0 pl-0">
				<div class="col-img  bg-overlay">
					<div class="bg-section">
						<img src= "whole/assets/images/banners/2.jpg" alt="Background"/>
					</div>
				</div>
			</div><!-- .col-md-6 end-->
...
<!-- Number Process #1
============================================= -->
<section id="number1" class="number number-1 bg-white pb-100">
	<div class="container">
		<div class="row clearfix">
			<div class="col-xs-12 col-sm-12 col-md-8 col-md-offset-2">
				<div class="heading heading-2 text--center mb-40">
					<p class="heading--subtitle">Free Your Creative Side!</p>
					<h2 class="heading--title">Best Solutions For Business</h2>
					<div class="divider--line">
						<i class="divider divider--1"></i>
						<i class="divider divider--2"></i>
						<i class="divider divider--3"></i>
		...
		<div class="row">
			<div class="col-xs-12 col-sm-4 col-md-4">
				<div class="number-panel">
					<div class="number--img">
						<img src="whole/assets/images/banners/4.jpg" alt="image">
					</div>
			...
			<div class="col-xs-12 col-sm-4 col-md-4">
				<div class="number-panel">
					<div class="number--img">
						<img src="whole/assets/images/banners/6.jpg" alt="image">
					</div>
					<div class="number--content">
...
<!-- Counter #3
============================================= -->
<section id="counter3" class="counter counter-dark bg-overlay bg-overlay-dark2">
	<div class="bg-section">
			<img src="whole/assets/images/counter/counter-1.jpg" alt="Background"/>
		</div>
	<div class="container">
		<div class="row">
			<!-- count #1 -->
			<div class="col-xs-6 col-sm-3 col-md-3">
				<div class="count-box text-center">
					...
					<div class="count-title">Total startups</div>
				</div>
			</div>
			<!-- .col-md-3 end -->
...
<!-- Team #2
============================================= -->
<section id="team1" class="team team-1 bg-white pb-90">
	<div class="container">
		<div class="row">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12">
				<div id="team-carousel" class="carousel-dots">
					<!-- Member #1 -->
					<div class="member">
							<div class="member-img">
								<img src="whole/assets/images/team/grid/1.jpg" alt="member"/>
					...
					<div class="member">
							<div class="member-img">
								<img src="whole/assets/images/team/grid/2.jpg" alt="member"/>
								<div class="member-overlay">
									<div class="member-social">
										<div class=" pos-vertical-center">
										<a href="#"><i class="fa fa-facebook"></i></a>
					...
					<div class="member">
							<div class="member-img">
								<img src="whole/assets/images/team/grid/3.jpg" alt="member"/>
								<div class="member-overlay">
									<div class="member-social">
										<div class=" pos-vertical-center">
										<a href="#"><i class="fa fa-facebook"></i></a>
					...
					<div class="member">
							<div class="member-img">
								<img src="whole/assets/images/team/grid/4.jpg" alt="member"/>
								<div class="member-overlay">
									<div class="member-social">
										<div class=" pos-vertical-center">
										<a href="#"><i class="fa fa-facebook"></i></a>
	...
	<div class="row clearfix">
			<div class="col-xs-12 col-sm-12 col-md-8 col-md-offset-2">
				<div class="heading heading-2 text--center mb-60">
					...
					<p class="heading--desc">Follow our latest news and thoughts which focuses exclusively on design, art, vintage, and also our latest work updates.</p>
				</div>
			</div><!-- .col-md-8 end -->
		</div>
		<div class="row">
			...
			<!-- Blog Entry #1 -->
				<div class="blog-entry">
					<div class="entry--img">
						<a href="#">
							<img src="whole/assets/images/blog/grid/1.jpg" alt="entry image"/>
						</a>
					</div>
					<div class="entry--meta">
					...
					<div class="entry--content">
						UX Designer is still a relatively profession, and one that is still being defined.  Emilia suggests it is an often...
					</div>
			...
			<!-- Blog Entry #2 -->
				<div class="blog-entry">
					...
					<div class="entry--content">
						Actually, Woodstock was not the first outdoor festival to feature multiple bands over several days performing...
					</div>
					<div class="entry--more">
						<a href="#">read more</a>
					</div>
			...
			<!-- Blog Entry #3 -->
				<div class="blog-entry">
					...
					<div class="entry--content">
						That may be true, but today, almost half a century later, Gary Eagle says it was only part of the story...
					</div>
					<div class="entry--more">
						<a href="#">read more</a>
					</div>
			...
			<!-- Blog Entry #5 -->
				<div class="blog-entry">
					...
					<div class="entry--content">
						To make 2015 your most lucrative year yet, you may have to do some things differently than what you've...
					</div>
					<div class="entry--more">
						<a href="#">read more</a>
			...
			<!-- Blog Entry #6 -->
				<div class="blog-entry">
					...
					<div class="entry--content">
						As the shimmering "City by the Bay," San Francisco’s distinctive terrain – water on one side, hills on the other
					</div>
					<div class="entry--more">
						<a href="#">read more</a>
					</div>
			...
			<!-- Blog Entry #7 -->
				<div class="blog-entry">
					...
					<div class="entry--content">
						The third Monday of January is supposed to be a depressing day of year. Whether you believe that or not...
					</div>
					<div class="entry--more">
						<a href="#">read more</a>
					</div>
...
<!-- Footer Scripts
============================================= -->
<script src="whole/assets/js/jquery-2.2.4.min.js"></script>
<script src="whole/assets/js/plugins.js"></script>
<script src="whole/assets/js/functions.js"></script>
<!-- RS5.0 Core JS Files -->
<script type="text/javascript" src="whole/assets/revolution/js/jquery.themepunch.tools.min838f.js?rev=5.0"></script>
<script type="text/javascript" src="whole/assets/revolution/js/jquery.themepunch.revolution.min838f.js?rev=5.0"></script>
<script type="text/javascript" src="whole/assets/revolution/js/extensions/revolution.extension.video.min.js"></script>
<script type="text/javascript" src="whole/assets/revolution/js/extensions/revolution.extension.slideanims.min.js"></script>
<script type="text/javascript" src="whole/assets/revolution/js/extensions/revolution.extension.actions.min.js"></script>
<script type="text/javascript" src="whole/assets/revolution/js/extensions/revolution.extension.layeranimation.min.js"></script>
<script type="text/javascript" src="whole/assets/revolution/js/extensions/revolution.extension.kenburn.min.js"></script>
<script type="text/javascript" src="whole/assets/revolution/js/extensions/revolution.extension.navigation.min.js"></script>
<script type="text/javascript" src="whole/assets/revolution/js/extensions/revolution.extension.migration.min.js"></script>
<script type="text/javascript" src="whole/assets/revolution/js/extensions/revolution.extension.parallax.min.js"></script>
<!-- RS Configration JS Files -->
<script src="whole/assets/js/rsconfig.js"></script>

</body>

<!-- Mirrored from 7oroof.com/tfdemos/whole/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Sep 2017 10:57:25 GMT -->
</html>
